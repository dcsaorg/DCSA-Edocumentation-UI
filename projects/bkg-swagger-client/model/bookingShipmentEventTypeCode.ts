...
/**
 * The status of the booking in the process. Possible values are - RECE (Received) - PENU (Pending Update) - PENC (Pending Confirmation) - CONF (Confirmed) - REJE (Rejected) - CANC (Cancelled) - CMPL (Completed)  More details can be found on <a href=\"https://github.com/dcsaorg/DCSA-Information-Model/blob/master/datamodel/referencedata.d/shipmenteventtypecodes.csv\">GitHub</a>. Be aware that the list provided here is a subset of the possible values. 
 */
export type BookingShipmentEventTypeCode = 'RECE' | 'PENU' | 'PENC' | 'CONF' | 'REJE' | 'CANC' | 'CMPL';

export const BookingShipmentEventTypeCode = {
    RECE: 'RECE' as BookingShipmentEventTypeCode,
    PENU: 'PENU' as BookingShipmentEventTypeCode,
    PENC: 'PENC' as BookingShipmentEventTypeCode,
    CONF: 'CONF' as BookingShipmentEventTypeCode,
    REJE: 'REJE' as BookingShipmentEventTypeCode,
    CANC: 'CANC' as BookingShipmentEventTypeCode,
    CMPL: 'CMPL' as BookingShipmentEventTypeCode
};