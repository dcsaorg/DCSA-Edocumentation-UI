...
/**
 * The unit of measure which can be expressed in either imperial or metric terms - FTQ (Cubic meter) - MTQ (Cubic foot) 
 */
export type VolumeUnit = 'MTQ' | 'FTQ';

export const VolumeUnit = {
    MTQ: 'MTQ' as VolumeUnit,
    FTQ: 'FTQ' as VolumeUnit
};