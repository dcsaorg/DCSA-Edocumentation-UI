...
/**
 * Refers to the shipment term at the loading of the cargo into the container. Options are defined in the Cargo Movement Type entity. - FCL (Full Container Load) - LCL (Less than Container Load) - BB (Break Bulk) 
 */
export type CargoMovementTypeAtOrigin = 'FCL' | 'LCL' | 'BB';

export const CargoMovementTypeAtOrigin = {
    FCL: 'FCL' as CargoMovementTypeAtOrigin,
    LCL: 'LCL' as CargoMovementTypeAtOrigin,
    BB: 'BB' as CargoMovementTypeAtOrigin
};