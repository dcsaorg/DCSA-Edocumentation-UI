...
/**
 * Indicates the type of service offered at Origin. Options are defined in the Receipt/Delivery entity. - CY (Container yard (incl. rail ramp)) - SD (Store Door) - CFS (Container Freight Station) 
 */
export type ReceiptTypeAtOrigin = 'CY' | 'SD' | 'CFS';

export const ReceiptTypeAtOrigin = {
    CY: 'CY' as ReceiptTypeAtOrigin,
    SD: 'SD' as ReceiptTypeAtOrigin,
    CFS: 'CFS' as ReceiptTypeAtOrigin
};