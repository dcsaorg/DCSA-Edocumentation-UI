...
/**
 * The unit for `airExchangeSetpoin` in metrics- or imperial units- per hour  - MQH (Cubic metre per hour) - FQH (Cubic foot per hour) 
 */
export type AirExchangeUnit = 'MQH' | 'FQH';

export const AirExchangeUnit = {
    MQH: 'MQH' as AirExchangeUnit,
    FQH: 'FQH' as AirExchangeUnit
};