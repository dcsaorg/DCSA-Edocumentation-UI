...
/**
 * Code of the value added service - SCON (Smart containers) - CINS (Cargo insurance) - SIOT (Smart IoT devices) - CDECL (Customs declaration) - SGUAR (Shipping guarantee) - UPPY (Upfront payment) 
 */
export type ValueAddedServiceCode = 'SCON' | 'CINS' | 'SIOT' | 'CDECL' | 'SGUAR' | 'UPPY';

export const ValueAddedServiceCode = {
    SCON: 'SCON' as ValueAddedServiceCode,
    CINS: 'CINS' as ValueAddedServiceCode,
    SIOT: 'SIOT' as ValueAddedServiceCode,
    CDECL: 'CDECL' as ValueAddedServiceCode,
    SGUAR: 'SGUAR' as ValueAddedServiceCode,
    UPPY: 'UPPY' as ValueAddedServiceCode
};