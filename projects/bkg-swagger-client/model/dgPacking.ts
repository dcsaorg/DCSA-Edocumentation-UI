...
/**
 * Object for inner and outer packing specification 
 */
export interface DgPacking { 
    /**
     * Packing quantity 
     */
    quantity?: number;
    /**
     * The code of the packing as per IMO 
     */
    imoPackingCode?: string;
    /**
     * The code of the packing as per UN recommendation 21 
     */
    unRecomemendation21PackingCode?: string;
    /**
     * Description of the packing  
     */
    description?: string;
}