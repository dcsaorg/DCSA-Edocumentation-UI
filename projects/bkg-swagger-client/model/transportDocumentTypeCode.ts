 ...
 */
export type TransportDocumentTypeCode = 'BOL' | 'SWB';

export const TransportDocumentTypeCode = {
    BOL: 'BOL' as TransportDocumentTypeCode,
    SWB: 'SWB' as TransportDocumentTypeCode
};