...
/**
 * Transport obligations, costs and risks as agreed between buyer and seller. - FCA (Free Carrier) - FOB (Free on Board) 
 */
export type IncoTerms = 'FCA' | 'FOB';

export const IncoTerms = {
    FCA: 'FCA' as IncoTerms,
    FOB: 'FOB' as IncoTerms
};