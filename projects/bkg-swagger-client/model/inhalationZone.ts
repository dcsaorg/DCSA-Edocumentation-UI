...
/**
 * The zone classification of the toxicity of the inhalant. Possible values are: - A () - B () - C () - D () 
 */
export type InhalationZone = 'A' | 'B' | 'C' | 'D';

export const InhalationZone = {
    A: 'A' as InhalationZone,
    B: 'B' as InhalationZone,
    C: 'C' as InhalationZone,
    D: 'D' as InhalationZone
};