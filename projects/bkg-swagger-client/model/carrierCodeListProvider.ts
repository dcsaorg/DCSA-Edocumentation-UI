 ...
 */
export type CarrierCodeListProvider = 'SMDG' | 'NMFTA';

export const CarrierCodeListProvider = {
    SMDG: 'SMDG' as CarrierCodeListProvider,
    NMFTA: 'NMFTA' as CarrierCodeListProvider
};