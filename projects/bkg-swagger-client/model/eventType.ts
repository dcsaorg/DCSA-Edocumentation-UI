...
/**
 * The type of the Event - to be used as a discriminator. Possible values are  - SHIPMENT (A Shippment event) - EQUIPMENT (An Equipment event) - TRANSPORT (A Transport event) 
 */
export type EventType = 'SHIPMENT' | 'EQUIPMENT' | 'TRANSPORT';
