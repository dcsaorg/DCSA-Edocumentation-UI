...
/**
 * Unit of measure used to describe the `Cargo Net Explosive Weight`. Possible values are - KGM (Kilograms) - GRM (Grams) 
 */
export type CargoNetExplosiveNecContentUnit = 'KGM' | 'GRM';

export const CargoNetExplosiveNecContentUnit = {
    KGM: 'KGM' as CargoNetExplosiveNecContentUnit,
    GRM: 'GRM' as CargoNetExplosiveNecContentUnit
};