 ...
 */
import { BookingDocumentStatusCancelled } from './bookingDocumentStatusCancelled';


export interface BookingsCarrierBookingRequestReferenceBody { 
    documentStatus: BookingDocumentStatusCancelled;
    /**
