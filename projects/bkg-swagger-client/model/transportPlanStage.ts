...
/**
 * Code qualifying a specific stage of transport e.g. pre-carriage, main carriage transport or on-carriage transport - PRC (Pre-Carriage) - MNC (Main Carriage Transport) - ONC (On-Carriage Transport) 
 */
export type TransportPlanStage = 'PRC' | 'MNC' | 'ONC';

export const TransportPlanStage = {
    PRC: 'PRC' as TransportPlanStage,
    MNC: 'MNC' as TransportPlanStage,
    ONC: 'ONC' as TransportPlanStage
};