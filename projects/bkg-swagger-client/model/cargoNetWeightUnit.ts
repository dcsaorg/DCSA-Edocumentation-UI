...
/**
 * Unit of measure used to describe the `Cargo Net Weight`. Possible values are - KGM (Kilograms) - GRM (Grams) 
 */
export type CargoNetWeightUnit = 'KGM' | 'GRM';

export const CargoNetWeightUnit = {
    KGM: 'KGM' as CargoNetWeightUnit,
    GRM: 'GRM' as CargoNetWeightUnit
};