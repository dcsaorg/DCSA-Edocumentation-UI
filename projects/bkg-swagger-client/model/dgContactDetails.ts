...
/**
 * 24 hr emergency contact details for Dangerous Goods 
 */
export interface DgContactDetails { 
    /**
    ...
    phone?: Phone;
    /**
     * Contract reference for the emergency DG support provided by an external third party vendor. 
     */
