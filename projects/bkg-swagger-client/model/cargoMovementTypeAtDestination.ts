...
/**
 * Refers to the shipment term at the unloading of the cargo out of the container. Options are defined in the Cargo Movement Type entity. - FCL (Full Container Load) - LCL (Less than Container Load) - BB (Break Bulk) 
 */
export type CargoMovementTypeAtDestination = 'FCL' | 'LCL' | 'BB';

export const CargoMovementTypeAtDestination = {
    FCL: 'FCL' as CargoMovementTypeAtDestination,
    LCL: 'LCL' as CargoMovementTypeAtDestination,
    BB: 'BB' as CargoMovementTypeAtDestination
};