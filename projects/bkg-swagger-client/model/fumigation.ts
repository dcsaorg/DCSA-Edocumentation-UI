...
/**
 * Indicate if this is a fumigated shipment  
 */
export interface Fumigation { 
    ...
    quantity?: number;
    /**
     * Unit used for the quantity. Possible values are  - KGM (Kilograms) - GRM (Grams) 
     */
    quantityUnit?: Fumigation.QuantityUnitEnum;
}
export namespace Fumigation {
    export type QuantityUnitEnum = 'KGM' | 'GRM';
    export const QuantityUnitEnum = {
        KGM: 'KGM' as QuantityUnitEnum,
        GRM: 'GRM' as QuantityUnitEnum
    };
}