...
import { IsShipperOwned } from './isShipperOwned';
import { RequestedEquipmentUnits } from './requestedEquipmentUnits';
...
export interface RequestedEquipment { 
    tareWeight?: TareWeight & any;
    tareWeightUnit?: WeightUnit & any;
    units: RequestedEquipmentUnits;
    /**
     * A list of equipments to be used by the shipper if known at the time of booking 
     */
    equipmentReferences?: Array<EquipmentReference & any>;
