 ...
 */
import { ShipmentLocationLocation } from './shipmentLocationLocation';
import { ShipmentLocationTypeCode } from './shipmentLocationTypeCode';
...
export interface ShipmentLocation {
    location: ShipmentLocationLocation;
