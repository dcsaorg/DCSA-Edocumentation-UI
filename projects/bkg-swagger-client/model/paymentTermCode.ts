...
/**
 * Indicates whether freight & charges are due for payment before the shipment is effected, practically before the transport document is released to shipper (Prepaid) or before the shipment is finalized meaning cargo released to consignee (Collect) - PRE (Prepaid) - COL (Collect) 
 */
export type PaymentTermCode = 'PRE' | 'COL';

export const PaymentTermCode = {
    PRE: 'PRE' as PaymentTermCode,
    COL: 'COL' as PaymentTermCode
};