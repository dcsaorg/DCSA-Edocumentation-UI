...
/**
 * Indicates the type of service offered at Destination. Options are defined in the Receipt/Delivery entity. - CY (Container yard (incl. rail ramp)) - SD (Store Door) - CFS (Container Freight Station) 
 */
export type DeliveryTypeAtDestination = 'CY' | 'SD' | 'CFS';

export const DeliveryTypeAtDestination = {
    CY: 'CY' as DeliveryTypeAtDestination,
    SD: 'SD' as DeliveryTypeAtDestination,
    CFS: 'CFS' as DeliveryTypeAtDestination
};