...
/**
 * Specifying which communication channel is to be used for this booking e.g. - EI (EDI transmission) - EM (Email) - AO (API) 
 */
export type CommunicationChannelCode = 'EI' | 'EM' | 'AO';

export const CommunicationChannelCode = {
    EI: 'EI' as CommunicationChannelCode,
    EM: 'EM' as CommunicationChannelCode,
    AO: 'AO' as CommunicationChannelCode
};