...
export class ShipmentService {
     ...
     */
    public v2ShipmentSummariesGet(documentStatus?: BookingDocumentStatus, limit?: number, sort?: string, aPIVersion?: string, observe?: 'body', reportProgress?: boolean): Observable<Array<ShipmentSummary>>;
    public v2ShipmentSummariesGet(documentStatus?: BookingDocumentStatus, limit?: number, sort?: string, aPIVersion?: string, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<Array<ShipmentSummary>>>;
    public v2ShipmentSummariesGet(documentStatus?: BookingDocumentStatus, limit?: number, sort?: string, aPIVersion?: string, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<Array<ShipmentSummary>>>;
    public v2ShipmentSummariesGet(documentStatus?: BookingDocumentStatus, limit?: number, sort?: string, aPIVersion?: string, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.request<Array<ShipmentSummary>>('get',`${this.basePath}/v2/shipment-summaries`,
            {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public v2ShipmentsCarrierBookingReferenceGet(carrierBookingReference: CarrierBookingReference, aPIVersion?: string, observe?: 'body', reportProgress?: boolean): Observable<Shipment>;
    public v2ShipmentsCarrierBookingReferenceGet(carrierBookingReference: CarrierBookingReference, aPIVersion?: string, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<Shipment>>;
    public v2ShipmentsCarrierBookingReferenceGet(carrierBookingReference: CarrierBookingReference, aPIVersion?: string, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<Shipment>>;
    public v2ShipmentsCarrierBookingReferenceGet(carrierBookingReference: CarrierBookingReference, aPIVersion?: string, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.request<Shipment>('get',`${this.basePath}/v2/shipments/${encodeURIComponent(String(carrierBookingReference))}`,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers,
                observe: observe,
