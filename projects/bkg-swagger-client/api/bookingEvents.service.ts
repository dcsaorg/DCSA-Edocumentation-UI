...
export class BookingEventsService {
     ...
     */
    public v1EventsGet(shipmentEventTypeCode?: Array<BookingShipmentEventTypeCode>, documentTypeCode?: Array<BookingDocumentTypeCode>, documentReference?: DocumentReference, equipmentReference?: EquipmentReference, eventCreatedDateTime?: EventCreatedDateTime, eventDateTime?: EventDateTime, limit?: number, sort?: string, aPIVersion?: string, observe?: 'body', reportProgress?: boolean): Observable<Array<ShipmentEvent>>;
    ...
    public v1EventsGet(shipmentEventTypeCode?: Array<BookingShipmentEventTypeCode>, documentTypeCode?: Array<BookingDocumentTypeCode>, documentReference?: DocumentReference, equipmentReference?: EquipmentReference, eventCreatedDateTime?: EventCreatedDateTime, eventDateTime?: EventDateTime, limit?: number, sort?: string, aPIVersion?: string, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.request<Array<ShipmentEvent>>('get',`${this.basePath}/v1/events/`,
            {
